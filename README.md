...
| `botstats` | 机器人流量统计 | [📖 guide](docs/plugins/botstats.md) | 按小时统计 Cloudflare 验证机器人各分类（含非机器人/真人）的访问次数，后台以走线图/饼图展示，可选时间范围与分类。 | [`source/plugin/botstats/`](Discuz_X3.5_SC_UTF8/upload/source/plugin/botstats/) |
